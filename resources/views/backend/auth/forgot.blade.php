                ...
                <div class="card pt-4">
                    <div class="card-body">
                        <div class="text-center mb-5">
                            ...
                            <p>Please input your email to reset password.</p>
                        </div>
                        ...
                        <form action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="text-center mt-3">
                               <button type="submit" class="btn btn-sm btn-primary"><i data-feather="rotate-cw"></i> Send link forgot password</button>
                            </div>
                        </form>
